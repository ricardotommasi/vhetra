...
export default function Proyectos() {
  return <div className="flex flex-col relative mx-6 gap-10 text-center">
    <div className="flex flex-row flex-wrap items-baseline gap-2 mx-auto justify-center">
      <h3 className="text-black text-2xl md:text-3xl font-semibold xs:shrink-0 ">
        Diferentes visiones, un mismo propósito,
      </h3>
      <h3 className="text-accent stroke-accent text-4xl md:text-6xl font-medium font-licorice xs:shrink-0">transformar elecciones en identidad.</h3>
    </div>
